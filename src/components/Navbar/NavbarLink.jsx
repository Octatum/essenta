...
import { withHeaderUnderline, PageHeaderStyledComponent } from '../PageHeader';
import { Select } from '../Input';

const TitleSection = withHeaderUnderline(styled.section`
  width: 100%;
`);
...
class FragancePickerView extends Component {
  ...
  render() {
    const { fragances, onFraganceClick, handleFilterChange } = this.props;
        ...
        <TitleSection>
          <TitleContentSection>
            ...
            <CustomSelect onChange={handleFilterChange}>
              ...
              <SelectOption value="Mujer">Mujer</SelectOption>
              <SelectOption value="Hombre">Hombre</SelectOption>
            </CustomSelect>
          </TitleContentSection>
        </TitleSection>
